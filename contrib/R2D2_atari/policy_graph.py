    ...
    class Model(object):
        def __init__(self,
            ...
            if is_training:
                ...
                self.qf1 = self.q_fn(feature, "q_target")
                q1f = self.qf[:, n_step:, :]
                ...
                self.n_step_qs = tf.stop_gradient(rescaleTarget(
...
def build_evaluator_model(kwargs):
    ...
    model = Model(act_space, gamma, n_step, rnn, use_hrnn, use_rmc, use_amc, use_reward_prediction,
