...
from XtoBeREMOVED.R2D2_super_mario_bros_v1.Worker_r2d2 import Worker_Q
from XtoBeREMOVED.R2D2_super_mario_bros_v1.Trainer_r2d2 import Model
...
def run(**kwargs):
    ...
    with tf.device("/gpu"):
        ...
        model = Model(act_space, lstm, "agent", **phs)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-BASE_DIR", type=str,
                        default="/mnt/cephfs_new_wj/arnold/labcv/xiaochangnan"
                                "/PPOcGAE_SuperMarioBros-v0/r2d2_2")
    parser.add_argument("-CKPT_DIR", type=str,
                        default="/mnt/cephfs_new_wj/arnold/labcv/xiaochangnan"
                                "/PPOcGAE_SuperMarioBros-v0/r2d2_2/ckpt")
