...
flags.DEFINE_string(
    "scriptdir",
    "/opt/tiger/test_ppo/examples/R2D2_super_mario_bros",
    "script dir")
...
from examples.R2D2_super_mario_bros.policy_graph import warp_Model
...
def build_policy_evaluator(kwargs):
    ...
    # pickle func in func
    from examples.R2D2_super_mario_bros.env import build_env
